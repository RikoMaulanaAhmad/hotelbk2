...
<div class="p-2 bg-secondary text-white text-center">
  <h1>HOTEL SMK_Brigjend Katamso II</h1>
  <p>Selamat datang di Hotel SMK_Brigjend Katamso II!</p> 
</div>
<!------------------AKHIR BAGIAN HEADER----------------- -->
...
<div class="container mt-2" id="panel_fasilitas_kami">
    <h2 class="text-center" >FASILITAS KAMI</h2>
      <h5 class="text-center">Hotel SMK</h5>
  ...
  <div class="d-flex justify-content-center">
    <div class="row">
     <div class="col-sm-12 p-5">
      ...
      <p> <b>Hotel SMK</b> Hotel ini khusus di buat untuk UKK_SMK Tahun 2022
    </p>
   </div>
  </div>
...
<div class="mt-5 p-2 bg-secondary text-white text-center">
  <p>@Desain by UKK SMK_RPL 2022</p>
</div>
