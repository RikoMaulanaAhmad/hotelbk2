...
<html lang="en">
<head>
  <title><?php echo "SMK Hotel - ".$nama; ?></title>
  <meta charset="utf-8">
...
<div id="invoice">
    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
            <header>
                <div class="row">
                    ...
                    <div class="col company-details">
                        ...
                        <div>Marelan, Brigjend Katamso II, INA</div>
                        <div>(123) 456-789</div>
                        <div>smk@gmail.com</div>
                    </div>
                </div>
            </header>
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <div class="address">Marelan, BK II, Indonesia</div>
            ...
            <footer>
                Bukti pemesanan kamar Hotel SMK Brigjend Katamso - Marelan - Indonesia.
            </footer>
        </div>
        <div></div>
    </div>
